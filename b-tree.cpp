...
int main()
{
    ...
    t.remove("f12345");
    cout << "Traversal of tree after removing \"f12345\" \n";
    t.traverse();
    cout << endl;

    t.remove("m12345");
    cout << "Traversal of tree after removing \"m12345\"\n";
    t.traverse();
    cout << endl;

    t.remove("g12345");
    cout << "Traversal of tree after removing \"g12345\"\n";
    t.traverse();
    cout << endl;

    t.remove("d12345");
    cout << "Traversal of tree after removing \"d12345\"\n";
    t.traverse();
    cout << endl;

    t.remove("b12345");
    cout << "Traversal of tree after removing \"b12345\"\n";
    t.traverse();
    cout << endl;

    t.remove("p12345");
    cout << "Traversal of tree after removing \"p12345\"\n";
    t.traverse();
    cout << endl;
}
